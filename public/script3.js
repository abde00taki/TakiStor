document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch(`http://localhost:3000/products/${productId}`)
    ...
    .then((product) => {
      ...
      div.innerHTML = `
            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" style="border: 1px solid whitesmoke; border-radius: 10px; box-shadow: 0 0 8px white; ">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlsNoTouching" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
        ...
        <button class="btn btn-primary mt-2">chop</button>
